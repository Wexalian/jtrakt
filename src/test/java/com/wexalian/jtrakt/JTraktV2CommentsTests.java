...
public class JTraktV2CommentsTests extends JTraktV2Tests {
    ...
    public void testGetComment() {
        TraktComment comment = TEST_TRAKT.getCommentsEndpoint().getComment(1);
    ...
    public void testGetReplies() {
        List<TraktComment> commentReplies = TEST_TRAKT.getCommentsEndpoint().getReplies(1, null);
    ...
    public void testAttachedMedia() {
        TraktAttachedMediaItem media = TEST_TRAKT.getCommentsEndpoint().getAttachedMedia(1, null);
    ...
    public void testCommentLikes() {
        List<TraktLike> likes = TEST_TRAKT.getCommentsEndpoint().getCommentLikes(1, null);
    ...
    public void testTrendingComments() {
        List<TraktItemComment> trendingComments = TEST_TRAKT.getCommentsEndpoint()
    ...
    public void testRecentComments() {
        List<TraktItemComment> recentComments = TEST_TRAKT.getCommentsEndpoint()
    ...
    public void testCommentUpdates() {
        List<TraktItemComment> commentUpdates = TEST_TRAKT.getCommentsEndpoint()
    ...
    public void testPostComment() {
        TraktNewCommentData data = new TraktNewCommentData(TEST_EPISODE, "This is a test comment, because the staging API has been down for quite a while now and I need to test my code :/", false, null);
        TraktComment comment = TEST_TRAKT.getCommentsEndpoint().postComment(data, TEST_ACCESS_TOKEN);
    ...
    public void testUpdateComment() {
        ...
        TraktComment comment = TEST_TRAKT.getCommentsEndpoint().updateComment(commentId, data, TEST_ACCESS_TOKEN);
    ...
    public void testPostReply() {
        ...
        TraktComment reply = TEST_TRAKT.getCommentsEndpoint().postReply(commentId, data, TEST_ACCESS_TOKEN);
    ...
    public void testLikeComment() {
        TEST_TRAKT.getCommentsEndpoint().likeComment(commentId, TEST_ACCESS_TOKEN);
    }
    ...
    public void testDeleteCommentLike() {
        TEST_TRAKT.getCommentsEndpoint().deleteCommentLike(commentId, TEST_ACCESS_TOKEN);
    }
    ...
    public void testDeleteComment() {
        TEST_TRAKT.getCommentsEndpoint().deleteComment(commentId, TEST_ACCESS_TOKEN);
    }
