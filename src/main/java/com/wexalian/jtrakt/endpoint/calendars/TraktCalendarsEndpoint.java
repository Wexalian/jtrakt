...
public class TraktCalendarsEndpoint {
    ...
    public List<TraktCalendarMovie> getMyDvd(@Nonnull OffsetDateTime date, int days, @Nonnull TraktAccessToken token, @Nullable Extended extended, @Nullable Filter.FilterEntry<?>... filters) {
    ...
    public List<TraktCalendarMovie> getAllDvd(@Nonnull OffsetDateTime date, int days, @Nullable Extended extended, @Nullable Filter.FilterEntry<?>... filters) {
