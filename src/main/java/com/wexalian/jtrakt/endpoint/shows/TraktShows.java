...
public class TraktShows
{
    ...
    {
        TraktQuery query = TraktQuery.create("shows/trending").pagination(pagination).extended(extended).filter(filters);
    ...
    {
        TraktQuery query = TraktQuery.create("shows/popular").pagination(pagination).extended(extended).filter(filters);
    ...
    {
        TraktQuery query = TraktQuery.create("shows/played/{period}").path("period", period).pagination(pagination).extended(extended).filter(filters);
    ...
    {
        TraktQuery query = TraktQuery.create("shows/watched/{period}").path("period", period).pagination(pagination).extended(extended).filter(filters);
    ...
    {
        TraktQuery query = TraktQuery.create("shows/collected/{period}").path("period", period).pagination(pagination).extended(extended).filter(filters);
    ...
    {
        TraktQuery query = TraktQuery.create("shows/anticipated").pagination(pagination).extended(extended).filter(filters);
    ...
    {
        TraktQuery query = TraktQuery.create("shows/{id}").path("id", showId).extended(extended);
    ...
    {
        TraktQuery query = TraktQuery.create("shows/{id}/aliases/{lang}").path("id", showId).path("lang", lang);
    ...
    {
        TraktQuery query = TraktQuery.create("shows/{id}/translations/{lang}").path("id", showId).path("lang", lang);
    ...
    {
        TraktQuery query = TraktQuery.create("shows/{id}/comments/{sort}").path("id", showId).path("sort", sort).pagination(pagination);
    ...
    public List<TraktList> getLists(@Nonnull String showId, @Nullable String type, @Nullable String sort, @Nullable Pagination pagination)
    {
        ...
        TraktQuery query = TraktQuery.create("shows/{id}/lists/{type}/{sort}").path("id", showId).path("type", type).path("sort", sort).pagination(pagination);
        
        return http.getAndParse(query, TraktTypeTokens.LISTS);
    }
    
    public TraktCollectionProgress.Show getCollectionProgress(@Nonnull String showId, boolean hidden, boolean specials, boolean count_specials, TraktAccessToken accessToken)
    {
    ...
    public TraktWatchedProgress.Show getWatchedProgress(@Nonnull String showId, boolean hidden, boolean specials, boolean count_specials, TraktAccessToken accessToken)
    {
    ...
    {
        TraktQuery query = TraktQuery.create("shows/{id}/people").path("id", showId).extended(extended);
    ...
    {
        TraktQuery query = TraktQuery.create("shows/{id}/ratings").path("id", showId);
    ...
    {
        TraktQuery query = TraktQuery.create("shows/{id}/related").path("id", showId).pagination(pagination).extended(extended);
    ...
    {
        TraktQuery query = TraktQuery.create("shows/{id}/stats").path("id", showId);
    ...
    {
        TraktQuery query = TraktQuery.create("shows/{id}/watching").path("id", showId).extended(extended);
    ...
    {
        TraktQuery query = TraktQuery.create("shows/{id}/next_episode").path("id", showId).extended(extended);
    ...
    {
        TraktQuery query = TraktQuery.create("shows/{id}/last_episode").path("id", showId).extended(extended);
